...
function LandingPageContent() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start" }}>
            ...
            >
              ≡ƒÄô Customized Portal for LPU {schoolConfig.name}
            </div>
              ...
              <div style={{ flex: 1, display: "grid", gridTemplateColumns: "1fr 1fr", overflow: "hidden" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", background: "#04060c", padding: 12 }}>
                  ...
                  >
                    ...
                    >
                      {isAutoPlay ? "ΓÅ╕ Pause" : "Γû╢ Autoplay"}
                    </button>
      ...
      {/* ΓöÇΓöÇ Section: Interactive How it Works Stepper ΓöÇΓöÇ */}
      <section
        id="how-it-works"
        style={{
          padding: "100px 24px",
      ...
      {/* ΓöÇΓöÇ Features Custom Visualizers Grid ΓöÇΓöÇ */}
      <section
        id="features"
        style={{
      ...
      {/* ΓöÇΓöÇ Pricing / Payment Portal Section ΓöÇΓöÇ */}
      <section
        id="pricing"
        style={{
          padding: "100px 24px",
        ...
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 32 }}>
            ...
            <div className="glass" style={{ padding: "40px 32px", borderRadius: "20px", display: "flex", flexDirection: "column", border: "1px solid var(--border)" }}>
              ...
              <div style={{ fontSize: "36px", fontWeight: 900, marginBottom: 32 }}>Γé╣0 <span style={{ fontSize: "14px", color: "var(--text-muted)" }}>/ semester</span></div>
              <ul style={{ listStyle: "none", padding: 0, margin: "0 0 40px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "14px", color: "var(--text-secondary)" }}>
                <li>Γ£ô 5 code traces per day</li>
                <li>Γ£ô Standard speed visualization</li>
                <li>Γ£ô Access to core visualizers</li>
                <li style={{ opacity: 0.5 }}>Γ£ù Live AI Tutor query support</li>
                <li style={{ opacity: 0.5 }}>Γ£ù Unlimited runtime history</li>
              </ul>
            ...
            <div className="glass" style={{ padding: "40px 32px", borderRadius: "20px", display: "flex", flexDirection: "column", border: `1px solid ${activeColor}50`, boxShadow: `0 0 32px ${activeColor}15`, position: "relative" }}>
              ...
              <div style={{ fontSize: "36px", fontWeight: 900, marginBottom: 32 }}>Γé╣299 <span style={{ fontSize: "14px", color: "var(--text-muted)" }}>/ semester</span></div>
              <ul style={{ listStyle: "none", padding: 0, margin: "0 0 40px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "14px", color: "var(--text-secondary)" }}>
                <li>Γ£ô Unlimited execution traces</li>
                <li>Γ£ô 50 AI Tutor credits / day</li>
                <li>Γ£ô Interactive step control buttons</li>
                <li>Γ£ô Variable watch-list panel</li>
                <li>Γ£ô Priority processing queue</li>
              </ul>
            ...
            <div className="glass" style={{ padding: "40px 32px", borderRadius: "20px", display: "flex", flexDirection: "column", border: "1px solid var(--border)" }}>
              ...
              <div style={{ fontSize: "36px", fontWeight: 900, marginBottom: 32 }}>Γé╣499 <span style={{ fontSize: "14px", color: "var(--text-muted)" }}>/ semester</span></div>
              <ul style={{ listStyle: "none", padding: 0, margin: "0 0 40px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "14px", color: "var(--text-secondary)" }}>
                <li>Γ£ô Everything in Pro</li>
                <li>Γ£ô Unlimited AI Tutor responses</li>
                <li>Γ£ô Full dynamic history storage</li>
                <li>Γ£ô Code export & PDF reports</li>
                <li>Γ£ô Mock syllabus exams & solutions</li>
              </ul>
